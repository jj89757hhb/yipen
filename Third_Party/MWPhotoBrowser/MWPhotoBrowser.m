...
//        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(actionButtonPressed:)];
    ...
    if (self.enterType==1) {//发布的入口
          _actionButton = [[UIBarButtonItem alloc] initWithTitle:@"删除" style:UIBarButtonItemStylePlain  target:self action:@selector(delAction)];
    }
...
-(void)delAction{
    ...
    [NotificationCenter postNotificationName:@"DeleteLocalPicture" object:nil];
}
...
//    [DataSource sharedDataSource].photoBrowserIsShow=YES;
...
//    [DataSource sharedDataSource].photoBrowserIsShow=NO;
