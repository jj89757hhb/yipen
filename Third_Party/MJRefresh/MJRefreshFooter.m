...
- (void)layoutSubviews
{
    ...
    //hhb修改
    if (self.tableType==UITableViewStyleGrouped) {//处理footer过高
//        self.loadMoreButton.frame=CGRectOffset(self.bounds, 0, -40);
//        self.noMoreLabel.frame=CGRectOffset(self.bounds, 0, -40);
//        self.stateLabel.frame=CGRectOffset(self.bounds, 0, -40);
    }
