...
//         self.tabBarView.backgroundColor = Clear_Color;
        self.tabBarView.delegate = self;
        [self.view addSubview:self.tabBarView];
        self.tabBarView.itemSelectedIndex = 0;
//        self.tabHeight=49+15;
            self.tabHeight=49;
...
//    [self presentViewController:_xm_centerViewController animated:YES completion:nil];
    ...
    Send1ViewController *send1Ctr=[[Send1ViewController alloc] initWithNibName:nil bundle:nil];
    UINavigationController *nav=[[UINavigationController alloc] initWithRootViewController:send1Ctr];
...
//    float tab_Height=(49+15);
    ...
    [UIView animateWithDuration:duration animations:^{
        if (hidden) {
            self.tabBarView.frame = CGRectMake(0, SCREEN_HEIGHT + _tabHeight+1, SCREEN_WIDTH, _tabHeight);
        }else{
//            self.tabBarView.frame = CGRectMake(0, SCREEN_HEIGHT-49, SCREEN_WIDTH, 49);
             self.tabBarView.frame = CGRectMake(0, SCREEN_HEIGHT-_tabHeight, SCREEN_WIDTH, _tabHeight);
        }
...
//        self.tabHeight=49+15;
               self.tabHeight=49;
        self.frame = CGRectMake(0, SCREEN_HEIGHT - _tabHeight, SCREEN_WIDTH, _tabHeight);
...
-(void)createUI{
    ...
    self.backgroundImageView.image=[UIImage imageNamed:@"tab-bg"];
//    [_backgroundImageView setFrame:CGRectMake(0, 0, SCREEN_WIDTH, 49)];
...
-(void)layoutSubviews{
    ...
    NSLog(@"tab_height:%f", self.frame.size.height);
//    float offY=15;
    float offY=0;
    self.line.frame = CGRectMake(0, 0+offY, self.frame.size.width, 0.5);
...
//        self.centerButton.backgroundColor=[UIColor blueColor];
    }
    ...
    for (int i = 0; i < self.buttonArray.count;i ++) {
        ...
        button.frame = CGRectMake(buttonX, 0.5+offY, buttonWidth, buttonHeight);
        buttonX += buttonWidth;
    }
