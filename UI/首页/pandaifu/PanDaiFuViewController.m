...
-(void)requestDataIsRefresh:(BOOL)isRefresh{
    ...
    NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",[NSNumber numberWithInteger:currentPage],@"Page",[NSNumber numberWithInteger:pageNum],@"PageSize",@"5",@"Type",senShu,SenShu,leiBie,LeiBie,chanDi,ChanDi,pinZhong,PinZhong,shuXin,ShuXin,chiCun,ChiCun,qiTa,QiTa, nil];
//      NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",[NSNumber numberWithInteger:currentPage],@"Page",[NSNumber numberWithInteger:pageNum],@"PageSize",@"5",@"Type", nil];
