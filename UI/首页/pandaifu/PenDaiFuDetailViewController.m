//
//  PenDaiFuDetailViewController.m
//  panjing
//
...
@interface PenDaiFuDetailViewController ()<UITableViewDataSource,UITableViewDelegate,PJPenDaiFuTableViewCellDeleagte,MWPhotoBrowserDelegate>
...
@implementation PenDaiFuDetailViewController
...
-(void)initTable{
    ...
    [myTable registerClass:[PJPenDaiFuTableViewCell class] forCellReuseIdentifier:identity];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        PJPenDaiFuTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identity];
        cell.delegate=self;
