...
#import "SendTuoGuanTableViewCell.h"
#import "ZYQAssetPickerController.h"
@interface SendTuoGuanViewController ()<UITableViewDataSource,UITableViewDelegate,UITextViewDelegate,ZYQAssetPickerControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
@property(nonatomic,strong)NSMutableArray *imgList;
@property(nonatomic,strong)SendTuoGuanTableViewCell *sendCell;
@end

@implementation SendTuoGuanViewController
...
-(void)initTable{
    ...
    [myTable registerNib:[UINib nibWithNibName:@"SendTuoGuanTableViewCell" bundle:nil] forCellReuseIdentifier:identify];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        SendTuoGuanTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identify forIndexPath:indexPath];
