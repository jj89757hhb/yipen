...
#import "SendXiangYuanTableViewCell.h"
#import "ZYQAssetPickerController.h"
@interface SendXiangYuanViewController ()<UITableViewDataSource,UITableViewDelegate,UITextViewDelegate,ZYQAssetPickerControllerDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
@property(nonatomic,strong)NSMutableArray *imgList;
@property(nonatomic,strong)SendXiangYuanTableViewCell *sendCell;
@end

@implementation SendXiangYuanViewController
...
//发布
-(void)sendAction{
    if ([_sendCell.titleTF.text length]==0) {
        [SVProgressHUD showErrorWithStatus:@"请输入标题"];
        return;
    }
    if (([_sendCell.contentTV.text length]==0)) {
    ...
    NSDictionary *dic=@{@"Uid":[DataSource sharedDataSource].userInfo.ID,
                        @"Title":_sendCell.titleTF.text,
                        @"Message":_sendCell.contentTV.text,
...
-(void)initTable{
    ...
    [myTable registerNib:[UINib nibWithNibName:@"SendXiangYuanTableViewCell" bundle:nil] forCellReuseIdentifier:identify];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        SendXiangYuanTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identify forIndexPath:indexPath];
