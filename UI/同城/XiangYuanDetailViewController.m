//
//  XiangYuanDetailViewController.m
//  panjing
//
...
#import "XiangYuanDetailTableViewCell.h"
#import "ActivityCommentTableViewCell.h"
#import "MWPhotoBrowser.h"
#import "StoreBottomView.h"
@interface XiangYuanDetailViewController ()<UITableViewDelegate,UITableViewDataSource,MWPhotoBrowserDelegate>
...
@implementation XiangYuanDetailViewController
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    content_Height+=  [CommonFun sizeWithString:info.Message font:[UIFont systemFontOfSize:content_FontSize_XiangYuanDetail] size:CGSizeMake(SCREEN_WIDTH-10*2, MAXFLOAT)].height;
    return 200+content_Height+Tree_Height_SameCity;
    //    return 400;
}

-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        XiangYuanDetailTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identifer];
        if (!cell) {
            cell=[[XiangYuanDetailTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifer];
        }
        [cell setInfo:_info];
...
-(void)collectAction:(UIButton*)sender{
    [SVProgressHUD show];
    Collect_Type type=KCollect_XiangYuan;
