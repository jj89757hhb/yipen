...
@interface SendYouYuanViewController ()<UITableViewDataSource,UITableViewDelegate,UITextViewDelegate,UINavigationControllerDelegate, ZYQAssetPickerControllerDelegate,UIImagePickerControllerDelegate>
@property(nonatomic,strong)NSMutableArray *imgList;
@property(nonatomic,strong)SendYouYuanTableViewCell *sendCell;
@end

@implementation SendYouYuanViewController
...
-(void)initTable{
    ...
    [myTable registerNib:[UINib nibWithNibName:@"SendYouYuanTableViewCell" bundle:nil] forCellReuseIdentifier:identify];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==0) {
        SendYouYuanTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:identify forIndexPath:indexPath];
