//
//  CollectionActivityViewController.m
//  panjing
//
...
@interface CollectionActivityViewController ()<UITableViewDataSource,UITableViewDelegate>{
    NSInteger currentPage;
    UITableView *myTable;
}
@property(nonatomic,strong)NSMutableArray *list;
@end
@implementation CollectionActivityViewController
...
-(void)deleteInfo:(NSIndexPath*)indexPath{
    ...
    NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",info.ID,@"BeID",@"2",@"Type", nil];
...
-(void)requestData{
    Collect_Type collectType=KCollect_Activity;
