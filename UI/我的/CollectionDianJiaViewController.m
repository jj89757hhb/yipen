//
//  CollectionDianJiaViewController.m
//  panjing
//
...
@interface CollectionDianJiaViewController ()<UITableViewDataSource,UITableViewDelegate>{
    NSInteger currentPage;
    UITableView *myTable;
}
@property(nonatomic,strong)NSMutableArray *list;
@end
@implementation CollectionDianJiaViewController
...
-(void)deleteInfo:(NSIndexPath*)indexPath{
    ...
    NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",info.ID,@"BeID",@"3",@"Type", nil];
...
-(void)requestData{
    Collect_Type collectType=KCollect_DianJia;
