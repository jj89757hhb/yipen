//
//  CollectionTuoGuanViewController.m
//  panjing
//
...
@interface CollectionTuoGuanViewController ()<UITableViewDataSource,UITableViewDelegate>{
    NSInteger currentPage;
    UITableView *myTable;
}
@property(nonatomic,strong)NSMutableArray *list;
@end
@implementation CollectionTuoGuanViewController
...
-(void)deleteInfo:(NSIndexPath*)indexPath{
    ...
    NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",info.ID,@"BeID",@"6",@"Type", nil];
...
-(void)requestData{
    Collect_Type collectType=KCollect_TuoGuan;
