...
#import "ShareDraftViewController.h"
@interface ShareViewController ()<DLSlideTabbarDelegate,DLTabedSlideViewDelegate>
...
-(void)initToolBar{
    ...
    DLTabedbarItem *item1 = [DLTabedbarItem itemWithTitle:@"已发布" image:nil selectedImage:nil];
    DLTabedbarItem *item2 = [DLTabedbarItem itemWithTitle:@"草稿箱" image:nil selectedImage:nil];
...
-(UIViewController*)DLTabedSlideView:(DLTabedSlideView *)sender controllerAt:(NSInteger)index{
    switch (index) {
        case 0:
        {
            ShareSendViewController *ctr=[[ShareSendViewController alloc] initWithNibName:nil bundle:nil];
            return ctr;
        }
        case 1:
        {
            ShareDraftViewController *ctr=[[ShareDraftViewController alloc] initWithNibName:nil bundle:nil];
            return ctr;
        }
        default:
            return nil;
