//
//  CollectionYouYuanViewController.m
//  panjing
//
...
@interface CollectionYouYuanViewController ()<UITableViewDataSource,UITableViewDelegate>{
    NSInteger currentPage;
    UITableView *myTable;
}
@property(nonatomic,strong)NSMutableArray *list;
@end
@implementation CollectionYouYuanViewController
...
-(void)deleteInfo:(NSIndexPath*)indexPath{
    ...
    NSDictionary *dic=[[NSDictionary alloc] initWithObjectsAndKeys:[DataSource sharedDataSource].userInfo.ID,@"UID",info.ID,@"BeID",@"4",@"Type", nil];
...
-(void)requestData{
    Collect_Type collectType=KCollect_YouYuan;
