...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.inputText=[[UITextField alloc] initWithFrame:CGRectMake(10, offY, SCREEN_WIDTH-offX*2, bottom_Height-offY*2)];
        [self addSubview:_inputText];
        _inputText.placeholder=@"请输入评论内容";
        self.sendBtn=[[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-70, offY, 60, 30)];
